...
class Bird(nt.Rig):
    SUB_RIG_BUIlD_TABLE = {
        cfg.LEFT + '_' + cfg.ARM: [sub_rig_templates.QuadrupedArm, {cfg.NAME: cfg.ARM, cfg.SIDE: cfg.LEFT}],
        cfg.RIGHT + '_' + cfg.ARM: [sub_rig_templates.QuadrupedArm, {cfg.NAME: cfg.ARM, cfg.SIDE: cfg.RIGHT}],
        ...
        cfg.LEFT + '_' + cfg.LEG: [sub_rig_templates.QuadrupedLeg, {cfg.NAME: cfg.LEG, cfg.SIDE: cfg.LEFT}],
        cfg.RIGHT + '_' + cfg.LEG: [sub_rig_templates.QuadrupedLeg, {cfg.NAME: cfg.LEG, cfg.SIDE: cfg.RIGHT}],
    ...
    def build_sub_rigs(self):
        super(Bird, self).build_sub_rigs()
